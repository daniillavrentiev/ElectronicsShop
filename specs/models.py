...
class CategoryFeature(models.Model):
    """
    Характкристика конкретной категории
    """
    ...
    feature_filter_name = models.CharField(max_length=50, verbose_name='Имя для фтльтра')
...
class ProductFeatures(models.Model):
    ...
    feature = models.ForeignKey(CategoryFeature, verbose_name='Харктеристика', on_delete=models.CASCADE)
